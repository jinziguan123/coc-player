...
export interface paths {
    ...
    "/api/sessions/{session_id}/join": {
        ...
        /**
         * Join Session
         * @description 进入大厅即预留真人席；角色可稍后选择或导入。
         */
        post: operations["join_session_api_sessions__session_id__join_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/sessions/{session_id}/luck-decision": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Decide Luck
         * @description 对「要不要花幸运扭转这一骰」拍板，随后系统把结算链走完（fire-and-forget）。
         *
         *     只有这一骰的主人能拍板：花的是他自己的幸运值，成败也记在他头上。
         */
        post: operations["decide_luck_api_sessions__session_id__luck_decision_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface operations {
    ...
    join_session_api_sessions__session_id__join_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    decide_luck_api_sessions__session_id__luck_decision_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["LuckDecisionRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
